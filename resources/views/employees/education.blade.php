    ...
    <div class="mb-4">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white">
            ...
            <div class="bg-white-100">
                ...
                {{--                        <li><a href="#tabs-3">Trainings & Courses</a></li>--}}
                {{--                        <li><a href="#tabs-4">Promotions</a></li>--}}
                {{--                        <li><a href="#tabs-5">Demotions</a></li>--}}
                {{--                        <li><a href="#tabs-6">Posting Records</a></li>--}}
                {{--                        <li><a href="#tabs-7">Punishments</a></li>--}}
                {{--                        <li><a href="#tabs-8">Show-Cause Notices</a></li>--}}
                {{--                        <li><a href="#tabs-9">Annual Confidential Report (ACR)</a></li>--}}
                {{--                        <li><a href="#tabs-10">List of Assets</a></li>--}}
                {{--                        <li><a href="#tabs-11">Family Profile</a></li>--}}
                {{--                    </ul>--}}
