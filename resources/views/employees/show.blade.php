            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg pb-8">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 mb-3 mt-0">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                        ...
                        <li class="mr-2">
                            <a href="{{route('employee.qualification.show', $employee->id)}}" class="inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" aria-current="page">
